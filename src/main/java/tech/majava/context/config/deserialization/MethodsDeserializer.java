/*
 *  majava - tech.majava.context.config.deserialization.MethodsDeserializer
...
public class MethodsDeserializer extends StdDeserializer<Methods> {
    ...
    /**
     * Deserializes the provided json to {@link tech.majava.context.config.Methods}
     *
     * @param p    the parser
     * @param ctxt the context
     * @return the parse {@link tech.majava.context.config.Methods}
