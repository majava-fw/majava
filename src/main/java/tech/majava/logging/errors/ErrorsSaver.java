/*
 *  majava - tech.majava.logging.errors.ErrorsSaver
...
package tech.majava.logging.errors;
...
public interface ErrorsSaver {
     ...
     * Saves the throwable, if it isn't already saved
     *
     * @param throwable the {@link tech.majava.serializable.SerializableThrowable} to be saved
     * @return the id to be used in {@link #get(String)} to get the throwable back
     */
    ...
    /**
     * Deletes the throwable by the {@link tech.majava.serializable.SerializableThrowable}
     *
     ...
     * @throws ThrowableNotFoundException if the id does not exist
     */
     ...
     * @return the found id
     * @throws ThrowableNotFoundException if the throwable does not exist
     */
