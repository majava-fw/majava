...
package cz.majksa.commons.majava.logging.errors;

import cz.majksa.commons.majava.serializable.SerializableThrowable;
...
public interface ErrorsSaver {
     ...
     * Saves the throwable, if it isn't already saved
     *
     * @param throwable the {@link cz.majksa.commons.majava.serializable.SerializableThrowable} to be saved
     * @return the id to be used in {@link #get(String)} to get the throwable back
     */
    ...
    /**
     * Deletes the throwable by the {@link cz.majksa.commons.majava.serializable.SerializableThrowable}
     *
     ...
     * @throws cz.majksa.commons.majava.logging.errors.ThrowableNotFoundException if the id does not exist
     */
     ...
     * @return the found id
     * @throws cz.majksa.commons.majava.logging.errors.ThrowableNotFoundException if the throwable does not exist
     */
