...
import cz.majksa.commons.majava.utils.FileUtils;
...
/**
 * <p><b>Class {@link cz.majksa.commons.majava.logging.errors.FileErrorsSaver}</b></p>
 *
 * @author majksa
 * @version 1.0.0
 * @since 1.0.0
...
public class FileErrorsSaver implements ErrorsSaver {
    ...
    @Nonnull
    @Override
    public SerializableThrowable delete(@NonNull String id) {
